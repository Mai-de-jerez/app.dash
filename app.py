...
import pandas as pd
import dash
from dash import html       # Actualiza la importación de html
from dash import dcc        # Actualiza la importación de dcc
...
def get_pie_chart(launch_site):
    if launch_site == 'ALL':
        ...
        fig = px.pie(data, names = 'class',title = 'Total Success Launches for site '+launch_site)
        return fig
# TASK 4:
...
def create_scatter(launch_site, payload):
    print(payload)
    if launch_site == 'ALL':
        ...
        filter_df = spacex_df[spacex_df['Launch Site']==launch_site]
